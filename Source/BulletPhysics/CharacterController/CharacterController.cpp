...
#include"GameObject/Character/CharacterControllerObject.h"
...
//   printf("walkSpeed=%f\n",walkSpeed);
   ...
   static_cast<GameObject::CharacterControllerObject*>( m_ghostObject->getUserPointer() )->checkArrivalInNexTime();
}
//---------------------------------------------------------------------------------------
